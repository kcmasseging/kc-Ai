...
export function toBuilderHandoff(intent: ProjectIntent): BuilderHandoff {
  ...
  return { contractVersion: '1', projectId: intent.projectId, projectName: intent.projectName, projectGoal: intent.projectGoal, purpose: intent.purpose, problem: intent.problem, targetUsers: [...intent.targetUsers], confirmedRequirements: [...intent.confirmedRequirements], functionalRequirements: [...intent.functionalRequirements], nonFunctionalRequirements: [...intent.nonFunctionalRequirements], designRequirements: [...intent.designRequirements], integrations: [...intent.integrations], securityRequirements: [...intent.securityRequirements], businessRules: [...intent.businessRules], constraints: [...intent.constraints], decisions: [...intent.decisions], dependencies: [...intent.dependencies], acceptanceCriteria: [...intent.acceptanceCriteria], specificationVersion: intent.version, approvedAt: intent.approvedAt };
}